angular.module('wui.date', []).directive('wuiDate', function() {
    ...
    function fieldTemplate(scope, element, attr) {
        return (
            ...
            '<input class="wui-input wui-input-block wui-date-input" type="text" placeholder="{{placeholder}}" ng-model="ngModel" autocomplete="off" ng-blur=checkDateFormat() ng-readonly="disabled"> ' +
            ...
            '<span class="title">' +
            '<span class="txt"><span>{{date.yearList.startYear}}</span>  - <span>{{date.yearList.endYear}}</span> </span>' +
            '</span>' +
