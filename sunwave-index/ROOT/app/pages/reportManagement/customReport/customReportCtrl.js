(function() {
    ...
    function customReportCtrl($rootScope, $scope, $log, $uibModal, deviceListService, areaService, customReportService, $http, messageAlertService) {
        $scope.xx = {
            select_all: ""
        };
        ...
        $scope.exportList = function(item) {
            ...
            if ($scope.query.reportId == null || $scope.query.reportId == '') {
                ...
                return $http({    
                    ...
                        
                    var filename = 'Custom Report.xlsx';  
