(function() {
    ...
    function deviceInformationReportCtrl($rootScope, $scope, $log, $uibModal, deviceInformationReportService, deviceListService, areaService, $http) {
        var setting = {
            view: {
        ...
        $scope.exportList = function(item) {
            ...
            return $http({
                ...
                var filename = 'Device Information.xlsx';
