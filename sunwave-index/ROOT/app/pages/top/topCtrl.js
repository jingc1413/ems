(function() {
    ...
    function topCtrl($rootScope, $scope, $log, topService, deviceListService, $uibModal, $filter, $state, messageAlertService) {
        ...
        $scope.getEleNames = function() {
            // if ($scope.tranEleName.length > 25) {
            //     messageAlertService.topoSearchFun('');
            //     return
            // } else {
        ...
        document.oncontextmenu = function() {
            ...
            //     $scope.showContextMen_Au = false;
            //     $scope.$apply();
            // } else if (isContextClick == undefined) {
        ...
        function clickFun(param) {
            ...
            if (($scope.topData.neElement == null) || ($scope.topData.neId == null) || ($scope.topData.name == null)) {
                alert("No device information")
            } else {
        ...
        $scope.queryDevice = function() {
            ...
            // $scope.topData.neElement

            $scope.neId = $scope.topData.neElement.neNeid;
            $scope.neDeviceIP = '';
            $scope.neDevicePort = '';
            ...
            $scope.devicetypeId = $scope.topData.neElement.neDevicetype.dtpDevicetypeid;
        ...
        $scope.deviceAddModal = function(item) {
            ...
            $scope.topData.neElement.areaName = $scope.topData.neElement.sysArea.areaName;
            var modalInstance = $uibModal.open({
                animation: true,
                backdrop: "static",
