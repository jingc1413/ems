...
function deviceListService($http) {
    ...
    var searchJson = function() {
        return $http.post('app/pages/deviceManagement/deviceList/test2.json');
    };
    ...
    var setReportLogControl = function(reportLogVo) {
        return $http({
            url: Url + '/sunwave-device-management/device/neElement/setReportLogControl',
            method: "POST",
            data: reportLogVo
        });
    };
    ...
    return {
        ...
        getTree_json: function() {
            return getTree_json();
        },
        searchJson: function() {
            return searchJson();
        },
        setReportLogControl: function(reportLogVo) {
            return setReportLogControl(reportLogVo);
        }
    }
}
// })();