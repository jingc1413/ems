(function() {
    ...
    function NotInServiceCtrl($rootScope, $scope, NotInServiceService, deviceListService, messageAlertService, $uibModal, $http) {
            ...
            if ($scope.checked.length == 0) {
                ...
                if ($scope.checkStatusFlag) {
                    ...
                    deviceListService.checkAlmMaskByNeIds(flagNum, neIDS.toString()).success(function(res) {
                        if (res.data == true) {
                            if (messageAlertService.confirmFun_alarm('sure')) {
                                //转到deviceList之前的检验
                                NotInServiceService.checkElementIntegrity(neIDS.toString()).success(function(res) {
                                    if (res.data.result == 'success') {
                                        ...
                                        messageAlertService.transferFun('not');
                                        return
                                    }
                                })
                            } else {
