angular.module('SunWave.pages.deviceManagement.CPEdeviceManagement.CPEdeviceDetails', [])
    .controller('dataModelCtrl', dataModelCtrl);

function dataModelCtrl($rootScope, $scope, AuthorizedService, $uibModal, $log, $stateParams) {
    $scope.navFunc = function(arg) {

        $scope.navAction = arg;
    };
    $scope.isLoading = false;
    $scope.OnlineStatus = $stateParams.OnlineStatus;
    ...
    // $scope.allItems = [];
    // $scope.paramName = '';
    // $scope.searchModelParam = function() {
    //     //console.log()
    // }
    ...
    var searchTree = function() {
        // //console.log(e)
        //  $scope.menuItems[0].select = !$scope.menuItems[0].select;
        //  $scope.isSearch = false;
        //  $scope.tranEleName = $scope.menuItems[0].name;
        //  $scope.neId = $scope.menuItems[0].id;
        //  $scope.treeQuery = {
