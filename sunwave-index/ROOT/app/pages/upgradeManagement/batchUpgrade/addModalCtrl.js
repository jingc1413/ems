(function() {
    ...
    function addModalCtrl($rootScope, $scope, batchUpgradeService, transmitModalItems, modifyData, deviceListService, PollingTaskService, isAdd, $uibModal, $uibModalInstance, areaService, $filter) {
                ...
                for (let i = 0; i < $scope.rows3_new.length; i++) {
                    switch (query2Params) {
                        ...
                        case 'coCompanyid':
                            ...
                            break;
                        case 'neRepeaterid16':
                            if ($scope.rows3_new[i].neRepeaterid16 == $scope.query2.neRepeaterid16) {
                                swArr.push($scope.rows3_new[i]);
                            ...
                            break;
                        case 'neName':
                            if ($scope.rows3_new[i].neName == $scope.query2.neName) {
                                swArr.push($scope.rows3_new[i]);
