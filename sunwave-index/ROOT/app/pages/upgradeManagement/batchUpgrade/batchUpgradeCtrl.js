(function() {
    ...
    function batchUpgradeCtrl($rootScope, $scope, batchUpgradeService, PollingTaskService, areaService, $uibModal, $log, messageAlertService) {
        ...
        $scope.openAddDialog = function() {
            ...
            var modalInstance = $uibModal.open({
                ...
                resolve: {
                    ...
                    deps: ['$ocLazyLoad',
                        function($ocLazyLoad) {
                            return $ocLazyLoad.load(['app/pages/upgradeManagement/batchUpgrade/addBatchModalCtrl.js']);
                        }
                    ]
                }
            });
