...
angular.module('SunWave.pages.LogManagement.HWLog', [])
    .controller('detailHwModalLogCtrl', detailHwModalLogCtrl);

function detailHwModalLogCtrl($rootScope, $scope, HWLogService, checkedItems, $filter, $http) {
    ...
    //导出
    $scope.exportListHwDetail = function() { 
        $rootScope.loading = true;
        return $http({    
            url: Url + '/sunwave-log-management/log/HWLog/export/detail',
                method: "POST",
                headers: {      
            ...
                
            var filename = 'HW Log Detail.xlsx';  
