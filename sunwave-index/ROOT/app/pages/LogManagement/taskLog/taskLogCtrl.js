(function() {
    ...
    function taskLogCtrl($rootScope, $scope, $log, $uibModal, taskLogService, $http) {
        $scope.checkbox = {
            select_all: "",
        }
        ...
        var searchForm = function() {
            ...
            $scope.clearAll();
            taskLogService.search($scope.query)
        ...
        ***************************************************************/
        ...
        $scope.exportList = function(item) { 
            $rootScope.loading = true;
            return $http({    
                url: Url + '/sunwave-log-management/log/manTaskLog/export',
                    method: "POST",
                    headers: {      
