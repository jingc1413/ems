(function() {
    ...
    function sysLogCtrl($rootScope, $scope, $uibModal, sysLogService, $http) {
        $scope.checkbox = {
            select_all: "",
        }
        $scope.query = { //查询条件
        ...
        var searchForm = function() {
            ...
            $scope.clearAll();
            sysLogService.searchContent($scope.query)
        ...
        ***************************************************************/
        ...
        $scope.detailHostName = function(item, $event) {
            var modalInstance = $uibModal.open({
                animation: true,
                backdrop: "static",
                templateUrl: 'app/pages/LogManagement/sysLog/detailHostNameModal.html',
                    ...
                    deps: ['$ocLazyLoad',
                        function($ocLazyLoad) {
                            return $ocLazyLoad.load([
                                'app/pages/LogManagement/sysLog/detailHostNameModalCtrl.js'
                            ]);
                        }
                    ]
                }
        ...
        $scope.exportList = function(item) { 
            $rootScope.loading = true;
            return $http({    
                url: Url + '/sunwave-log-management/log/sysLog/export',
                    method: "POST",
                    headers: {      
