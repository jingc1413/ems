angular.module('SunWave.pages.Authority.role', ['SunWave.pages.Authority.area',
    ...
    .controller('areaTreeModalCtrl_role', areaTreeModalCtrl_role);

function areaTreeModalCtrl_role($scope, isArea, role, roleService, organizationService, areaService, $uibModalInstance, messageAlertService) {
