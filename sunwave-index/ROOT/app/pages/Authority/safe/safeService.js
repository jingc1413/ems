...
function safeService($http) {
    ...
    var copySysUser = function(password, userId, userName) {
        return $http({
            url: Url + '/sunwave-authority/authority/sysUser/copySysUser',
            method: "POST",
            params: {
                'password': password,
                'userId': userId,
    ...
    var unLock = function(ids) {
        return $http({
            url: Url + '/sunwave-authority/authority/sysUser/unlockNow',
            method: "POST",
            params: {
                'ids': ids
            }
    ...
    return {
        ...
        copySysUser: function(password, userId, userName) {
            return copySysUser(password, userId, userName);
        },
        unLock: function(ids) {
            return unLock(ids);
        }
