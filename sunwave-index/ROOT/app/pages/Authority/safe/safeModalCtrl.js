...
function safeModalCtrl($rootScope, $scope, isAdd, item, safeService, $uibModal, $uibModalInstance, $log, messageAlertService) {
    ...
    $scope.saveEdit = function() {
        ...
        if (isAdd == "Add") {
            ...
            if ($scope.user.password == null) {
                ...
                messageAlertService.userPasswordFun('required');
            } else {

                newItems.sysAreaSet = $scope.treeNode;
                newItems.sysroleSet = $scope.newRoles;
                // safeService.checkUserName(newItems.username).success(function(res) {
                //     if (res.data == true) {
