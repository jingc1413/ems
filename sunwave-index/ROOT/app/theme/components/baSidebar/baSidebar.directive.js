(function() {
    ...
    /** @ngInject */
    function baSidebar($timeout, baSidebarService, baUtil, layoutSizes, $templateRequest, $compile, $window, $state) {
        var jqWindow = $(window);
        return {
            restrict: 'E',
            ...
            link: function(scope, el) {
                ...
                scope.$on("toSidebar", function(event, data) {
                    ...
                    //模板重载
                    $templateRequest("app/theme/components/baSidebar/ba-sidebar.html").then(function(html) {
                ...
                var menuHeights = el[0].childNodes[0].clientHeight;
                if (menuHeights == 0) {
                    menuHeights = document.body.clientHeight;
                }
                scope.menuHeight = menuHeights - 65;
                ...
                scope.$watch("getSideBarData", function(newValue, oldValue) {
                    //数据变化监控.
                });
            }
        };
