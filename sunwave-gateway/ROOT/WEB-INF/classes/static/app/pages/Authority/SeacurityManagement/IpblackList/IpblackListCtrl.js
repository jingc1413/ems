(function() {
    ...
    angular.module('SunWave.pages.Authority.SeacurityManagement.IpblackList', [])
        .controller('IpblackListCtrl', IpblackListCtrl);

    function IpblackListCtrl($rootScope, $scope, IpblackListService, $uibModal, $log) {
        ...
        var searchForm = function() {
            ...
            IpblackListService.search($scope.query)
        ...
        ***************************************************************/
        ...
        $scope.save = function() {
            if (confirm('Are U Sure Modify?')) {
                ...
                IpblackListService.modifyRule($scope.log).success(function(res) {
                    if (res.data == true) {
                        alert('success!');
        ...
        $scope.deleteItem = function() {
            if ($scope.checked.length == 0) {
                ...
                if (confirm("Are U Sure?")) {
                    console.log($scope.checkedItems);
                    IpblackListService.deleteItem($scope.checked.toString()).success(function(response) {
        ...
        $scope.deleteItem_black = function() {
            if ($scope.checked2.length == 0) {
                ...
                if (confirm("Are U Sure?")) {
                    console.log($scope.checkedItems2);
                    IpblackListService.deleteItem_black($scope.checked2.toString()).success(function(response) {
        ...
        $scope.openAddModal = function() {
            var modalInstance = $uibModal.open({
                animation: true,
                backdrop: "static",
                templateUrl: 'app/pages/Authority/SeacurityManagement/IpblackList/IpModal.html',
                ...
                resolve: {
                    ...
                    IpblackListService: function() {
                        return IpblackListService;
                    },

                    deps: ['$ocLazyLoad',
                        function($ocLazyLoad) {
                            return $ocLazyLoad.load(['app/pages/Authority/SeacurityManagement/IpblackList/addIpCtrl.js']);
                        }
                    ]
                }
            });
