(function() {
    ...
    function deviceListCtrl($scope, deviceListService, $uibModal, $http) {
        ...
        var searchForm = function() {
            ...
            deviceListService.searchContent($scope.query)
                .success(function(response) {
                    ...
                    //     if (item.neSitelevelid == 1) {
                    //         item.neSitelevelid = 'Normal';
                    //     } else if (item.neSitelevelid == 2) {
                    //         item.neSitelevelid = 'Vip';
                    //     } else {
                    //         item.neSitelevelid = '';
                    //     }
                    // }
