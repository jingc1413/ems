...
function batchUpgradeService($http) {
    ...
    return {
        ...
        modifyPollTask: function(duration, fileId, neIds, objSetParam, objSetParamValue, objectIdAlarm, objectIdAlarmEn, objectIdBase, objectIdRadio, tskFilter, tskIsuse, tskNexttime, tskPeriod, tskStyle, tskTaskid, tskTaskname) {
            return modifyPollTask(duration, fileId, neIds, objSetParam, objSetParamValue, objectIdAlarm, objectIdAlarmEn, objectIdBase, objectIdRadio, tskFilter, tskIsuse, tskNexttime, tskPeriod, tskStyle, tskTaskid, tskTaskname);
        },
