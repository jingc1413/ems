...
function PollingTaskService($http) {
    ...
    return {
        ...
        savePollTaskElements: function(duration, fileId, neIds, objSetParam, objSetParamValue, objectIdAlarm, objectIdAlarmEn, objectIdBase, objectIdRadio, tskFilter, tskIsuse, tskNexttime, tskPeriod, tskStyle, tskTaskname) {
            return savePollTaskElements(duration, fileId, neIds, objSetParam, objSetParamValue, objectIdAlarm, objectIdAlarmEn, objectIdBase, objectIdRadio, tskFilter, tskIsuse, tskNexttime, tskPeriod, tskStyle, tskTaskname);
        },
        modifyPollTaskElements: function(duration, fileId, neIds, objSetParam, objSetParamValue, objectIdAlarm, objectIdAlarmEn, objectIdBase, objectIdRadio, tskFilter, tskIsuse, tskNexttime, tskPeriod, tskStyle, tskTaskid, tskTaskname) {
            return modifyPollTaskElements(duration, fileId, neIds, objSetParam, objSetParamValue, objectIdAlarm, objectIdAlarmEn, objectIdBase, objectIdRadio, tskFilter, tskIsuse, tskNexttime, tskPeriod, tskStyle, tskTaskid, tskTaskname);
        },
